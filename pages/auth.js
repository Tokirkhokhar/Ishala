                        ...
                        loginSignup ?
                            ...
                            <div className="border rounded-sm min-w-[400px] max-w-md space-y-3 p-8 shadow-xl text-gray-600 bg-gray-50 ml-24">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <input type='email' ref={emailRef} placeholder="tokir@example.com" className="outline-none p-[6px] border shadow-md rounded-sm border-gray-300 hover:border-sky-500  w-full" />
                                </div>
                                <div className="space-y-1">
                                ...
                                <div className="grid w-fit grid-cols-2 gap-10">
                                    <div className="flex flex-col space-y-1">
                                        ...
                                        <input type='first name' ref={fnameRef} placeholder="tokir" className="shadow-md outline-none border inline rounded-sm border-gray-300 hover:border-sky-500 p-[6px]" />
                                    </div>
                                    <div className="flex flex-col space-y-1">
                                        <label className="block font-semibold">Last Name</label>
                                        <input type='first name' ref={lnameRef} placeholder="Khokhar" className="shadow-md outline-none border inline rounded-sm border-gray-300 hover:border-sky-500 p-[6px]" />
                                    </div>
                                </div>
