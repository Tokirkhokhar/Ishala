    ...
    <>
      <div className="p-14 justify-center text-center text-4xl">
        <p className=" font-semibold text-gray-800">
          work from home job/internship at Ahemdabad
        </p>
      </div>
      <div>
        <div className="max-w-screen-lg min-h-screen border rounded-lg mx-auto mb-12">
          ...
          <div className="bg-white p-5 w-full space-y-5 ">
            <div className="border rounded-md inline-flex">
              ...
              <p className="text-gray-800  text-sm inline p-1">
                Actively hiring
              </p>
            </div>
            <div className="space-y-1">
              <p className="text-gray-800 font-semibold text-xl cursor-pointer">
                Web Development
              </p>
            ...
            <div className="flex space-x-10 text-sm">
              ...
              <p className="bg-gray-200 border rounded-md text-gray-700 p-1 font-semibold">
                Internship
              </p>
              <p className="bg-gray-200 border rounded-md text-gray-700 p-1 font-semibold">
            ...
            <div className="space-y-2">
              ...
              <p className="text-base text-gray-500">
                ...
                non-profit organization committed to bringing the best
                educational resources to under-served tribal communities of
                Chandrapur district (Maharashtra). We always stressed on
                activities and strategies that cover the whole cycle of what is
                required for providing quality education to an individual child
                in a structured manner. Our mission is to build a platform for
                vulnerable and oppressed children, living in poverty. Thus
                empowering them with a well-equipped education system and
                gaining knowledge to alleviate poverty
              </p>
            </div>
            ...
            <div className="space-y-1">
              <p className="text-xl text-gray-800 font-semibold">Perks</p>
              <div className="flex space-x-10 text-gray-700">
                <p className="border rounded-md bg-gray-100 p-1 outline-none">
                  Certificate
                </p>
                <p className="border rounded-md bg-gray-100 p-1">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-700">
                ...
                performance-linked incentive (10% of total funds raised).
              </p>
            </div>
            ...
            <div className="flex items-center justify-center">
              <Link href="/resume">
                <button
                  className="bg-sky-400 text-white font-semibold border rounded-md p-3 w-32 text-lg 
                             cursor-pointer hover:bg-sky-500 shadow-lg text-center mx-auto"
                >
                  Apply now
                </button>
              </Link>
