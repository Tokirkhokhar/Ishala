                    ...
                    <div className="border border-gray-200 rounded-md p-7 space-y-4 max-w-xl mx-auto">
                        ...
                        <div className="flex space-x-5">
                            <div className="flex flex-col flex-1 space-y-1">
                                ...
                                <input type='first name' ref={FnameRef} placeholder="tokir" className=" outline-none border inline rounded-sm
                             border-gray-300 hover:border-sky-500 p-[6px] w-full" />
                            </div>
                            <div className="flex flex-col flex-1 space-y-1">
                                <label className="block font-semibold">Last Name</label>
                                <input type='first name' ref={LnameRef} placeholder="Khokhar" className="outline-none border inline rounded-sm border-gray-300 hover:border-sky-500 p-[6px] w-full" />
                            </div>
                        </div>

                        <div className="space-y-1">
                            <label className="block font-semibold ">Email</label>
                            <input type='email' ref={EmailRef} placeholder="tokir@example.com" className="outline-none p-[6px] border rounded-sm border-gray-300 hover:border-sky-500 w-full" />
                        </div>
                        <div className="space-y-1">
